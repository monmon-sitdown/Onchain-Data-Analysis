...
token_transfer_detail as (
    ...
    where p.blockchain = 'arbitrum'
        and t.evt_block_time >= date('2021-06-01') -- first pool created date
    ...
    where p.blockchain = 'ethereum'
        and t.evt_block_time >= date('2021-05-04') -- first pool created date
    ...
    where p.blockchain = 'optimism'
        and t.evt_block_time >= date('2021-11-11') -- first pool created date
    ...
    where p.blockchain = 'polygon'
        and t.evt_block_time >= date('2021-12-20') -- first pool created date
